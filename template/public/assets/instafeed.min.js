        ...
        this.display = function(data) {
            ...
            if (this.options.display_gallery) {
                ...
                if (typeof data.is_private !== "undefined" && data.is_private === true) {
                    ...
                    html += "<div class='instagram_gallery row mx-0'>";
                    for (var i = 0; i < max; i++) {
                        ...
                        if (type_resource != "video"){
                            html += "<a  href='" + url + (this.options.display_captions? "' data-caption='" + caption : "") + "' class='col-6 col-sm-2 px-0 instagram-" + type_resource + "' rel='noopener' target='_blank'" + styles.gallery_image_link + ">";
